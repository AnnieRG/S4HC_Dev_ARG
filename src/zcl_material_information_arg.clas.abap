CLASS zcl_material_information_arg DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_material_information_arg IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA material_info TYPE REF TO zcl_material_information_arg.
    material_info = NEW zcl_material_information_arg(  ).
